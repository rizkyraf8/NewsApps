...
import id.rizkyraf.bankmandiri.course.databinding.ActivitySourcesDetailBinding
...
@AndroidEntryPoint
class SourceDetailActivity : BaseActivity<ActivitySourcesDetailBinding>(
    ActivitySourcesDetailBinding::inflate
) {
    ...
    private fun initView() {
        binding.apply {
            rvBreakingNews.apply {
                ...
                addOnScrollListener(this@SourceDetailActivity.scrollListener)
            }

            tvTitle.text = sourceId
        }
    ...
    private fun requestData() {
        viewModel.getBreakingNews(source = sourceId)
    }
                ...
                when (it) {
                    ...
                    is Resource.Error -> {
                        ...
                        it.message?.let { message ->
                            Toast.makeText(this@SourceDetailActivity, message, Toast.LENGTH_SHORT)
                                .show()
                        }
                    }
                    is Resource.Loading -> {
