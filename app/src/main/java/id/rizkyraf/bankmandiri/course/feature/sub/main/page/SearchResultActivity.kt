...
import id.rizkyraf.bankmandiri.course.databinding.ActivityResultSearchBinding
import id.rizkyraf.bankmandiri.course.feature.sub.main.page.adapter.ArticlesAdapter
import id.rizkyraf.bankmandiri.course.feature.sub.main.viewmodel.SearchNewsViewModel
...
@AndroidEntryPoint
class SearchResultActivity : BaseActivity<ActivityResultSearchBinding>(
    ActivityResultSearchBinding::inflate
) {
                ...
                when (it) {
                    ...
                    is Resource.Error -> {
                        ...
                        it.message?.let { message ->
                            Toast.makeText(this@SearchResultActivity, message, Toast.LENGTH_SHORT)
                                .show()
                        }
                    }
                    is Resource.Loading -> {
